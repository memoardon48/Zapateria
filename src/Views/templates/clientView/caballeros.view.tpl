<div class="container-fluid">
  <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb m-4">
      ...
      <li class="breadcrumb-item active" aria-current="page">Caballeros</li>
    </ol>
  </nav>
  <h1 class="m-4">COMPRAR ESTILOS DE CABALLEROS</h1>
...
<div class="container-fluid m-4">
  ...
  <div class="row">
    ...
    <ul class="dropdown-menu">
      {{foreach marcas}}
        <li><a class="dropdown-item" href="index.php?page=clientView-caballeros&marcacod={{marcacod}}">{{nombremarca}}</a></li>
      {{endfor marcas}}
        <li><a class="dropdown-item" href="index.php?page=clientView-caballeros">Todas</a></li>
    </ul>
  </div>
   <form action="index.php" method="get" class="d-flex col-sm-12 col-md-8">
      <input type="hidden" name="page" value="clientView-caballeros"/>
